(c) 2021 Alexander Iwoh

Files:
    A2.pro
    Floor.h, Floor.cc
    Elevator.h, Elevator.cc
    ECS.h, ECS.cc
    View.h, View.cc
    Passenger.h, Passenger.cc
    mainwindow.h, mainwindow.cc
    main.cc
    Readme

This project is an elevator simulator. The GUI was created using code so you will
have to run the project folder in Qt Creator to see the GUI. If you have trouble
running it try using "Build > Run without Deployment" to run the code.
